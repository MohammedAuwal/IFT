...
class _DriverModeScreenState extends State<DriverModeScreen> {
  ...
  Future<void> _startSharing() async {
    ...
    _locationSub = _locationService.watchCurrentLatLng().listen((latLng) async {
      await _firebaseService.updateRideStatus(
        rideId: widget.ride.id,
        status: 'on_the_way',
        driver: widget.driverName,
  ...
  Future<void> _markRideInProgress() async {
    await _firebaseService.updateRideStatus(
      rideId: widget.ride.id,
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  _sharing ? 'Live location sharing is ON' : 'Live location sharing is OFF',
                  style: GoogleFonts.poppins(
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: _sharing ? null : _startSharing,
                ...
                SizedBox(
                  width: double.infinity,
                  child: ElevatedButton(
                    onPressed: _sharing ? _markRideInProgress : null,
                    child: const Text('Mark Ride In Progress'),
                  ),
                ),
                const SizedBox(height: 12),
                SizedBox(
