...
// Direct-send Option A for Mix app
// This function accepts target FCM tokens and a payload,
// then sends a push notification using Firebase Cloud Messaging HTTP v1.
  ...
  const message = {
    message: {
      ...
      android: {
        priority: "high",
        notification: {
          channel_id: "mix_high_importance_channel",
        },
      },
    },
  };
